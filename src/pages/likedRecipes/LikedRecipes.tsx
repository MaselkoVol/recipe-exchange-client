...
import { useLazyGetCurrentUserLikedRecipesQuery } from "../../app/services/likesApi";
import RecipeList from "../../components/RecipeList";

type Props = {};

const LikedRecipes = (props: Props) => {
  ...
  const [getRecipes, { data, error, isFetching }] = useLazyGetCurrentUserLikedRecipesQuery();
